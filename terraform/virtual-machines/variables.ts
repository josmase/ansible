...
export function vmVariables(stack: TerraformStack) {
  return {
    ...
    proxmoxStorage: new TerraformVariable(stack, "proxmox_storage", {
      description:
        "The name of the storage space to put all container disks in",
      type: VariableType.STRING,
    }),
    ...
    ubuntuTemplateSmall: new TerraformVariable(stack, "ubuntu_template_small", {
      description:
    ...
    ubuntuTemplateLarge: new TerraformVariable(stack, "ubuntu_template_large", {
